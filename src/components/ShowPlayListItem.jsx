    ...
    >
      ...
      >
        <div className="flex w-full gap-4 p-2 ">
          <div
            id="showPlayListImg"
            className="max-w-[45px] max-h-[45px] max-[700px]:max-w-[35px] max-[700px]:max-h-[35px]   overflow-hidden rounded-lg border-[2px] border-elevatedHighlight p-1 transition-all  "
          >
            <img
